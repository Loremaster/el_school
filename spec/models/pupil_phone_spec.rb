...
describe PupilPhone do
  ...
  describe "Validations" do
    describe "Rejection" do
      ...
      it "should reject home phone with no digits" do
        phone = @attr_pupil_phones.merge( :pupil_mobile_number => 'sdf' )
        @pupil.build_pupil_phone( phone ).should_not be_valid
      end

      it "should reject mobile phone with no digits" do
        phone = @attr_pupil_phones.merge( :pupil_home_number => 'sdf' )
        @pupil.build_pupil_phone( phone ).should_not be_valid
      end
    end
